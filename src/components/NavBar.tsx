    ...
    <nav className="fixed top-0 left-0 bottom-0 z-40 bg-[#FBF8F3] dark:bg-[#0A1114] border-r border-[#EAE3D5] dark:border-[#1E2C33] shadow-lg flex flex-col justify-between transition-all duration-300 w-16 md:w-64 py-6">
      ...
      <div className="px-3 md:px-6">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-[#0E3D4D] flex items-center justify-center shadow-md shadow-[#0E3D4D]/25 transition-transform duration-300 group-hover:scale-105">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip on Mobile (collapsed sidebar) */}
              <div className="absolute left-full ml-4 px-2.5 py-1.5 bg-[#0E3D4D] text-white text-[10px] font-bold rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 shadow-md md:hidden pointer-events-none">
                {item.label}
              </div>
            </Link>
          );
      ...
      <div className="px-3 md:px-6 mt-auto">
        <div className="flex items-center justify-center md:justify-start mb-2 relative group/theme">
          ...
          >
            {!mounted ? (
              <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 md:mr-2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                </svg>
                <span className="text-xs font-semibold hidden md:inline">Modo Escuro</span>
              </>
            ) : theme === 'dark' ? (
              <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 md:mr-2 text-amber-500">
              ...
              <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 md:mr-2 text-[#0E3D4D]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                </svg>
                <span className="text-xs font-semibold hidden md:inline">Modo Escuro</span>
              </>
          ...
          <div className="absolute left-full ml-4 px-2.5 py-1.5 bg-[#0E3D4D] text-white text-[10px] font-bold rounded-lg opacity-0 invisible group-hover/theme:opacity-100 group-hover/theme:visible transition-all duration-200 whitespace-nowrap z-50 shadow-md md:hidden pointer-events-none">
            Alternar tema
          </div>
        </div>
