...
export default function HojePage({ dadosIniciais, metricasIniciais }: HojePageProps) {
  ...
  return (
    <div className="w-full max-w-md md:max-w-5xl mx-auto bg-transparent min-h-screen pb-24 px-4 pt-6 select-none font-poppins">
      ...
      {activeTab === 'hoje' ? (
        !ciclo || !ciclo.ciclo || !ciclo.ciclo.ativo ? (
          <div className="w-full bg-white border border-[#EAE3D5] rounded-3xl p-8 md:p-12 shadow-sm flex flex-col items-center justify-center text-center space-y-6 max-w-2xl mx-auto my-12 transition-all">
            {/* Visual element / Icon with premium styling */}
            <div className="w-20 h-20 rounded-full flex items-center justify-center shadow-inner bg-[#E0EBF0] dark:bg-[#0E3D4D]/30 text-[#0E3D4D] dark:text-[#E0EBF0]">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight font-lora-read text-[#0E3D4D] dark:text-[#E2E8F0]">
                Aguardando o início do seu ciclo de estudos para 2027!
              </h2>
              <p className="text-sm md:text-base max-w-md mx-auto leading-relaxed text-gray-500 dark:text-gray-300">
            ...
            <div className="pt-4 w-full max-w-xs">
              <div className="bg-[#FBF8F3] dark:bg-[#1B2A33] border border-[#EAE3D5] dark:border-[#344854] rounded-2xl p-4 text-xs font-medium text-gray-600 dark:text-gray-300">
                <span className="block font-bold mb-1 text-[#0E3D4D] dark:text-[#E0EBF0]">Dica de Preparação</span>
